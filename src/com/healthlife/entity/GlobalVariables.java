...
public class GlobalVariables {
	...
	public final static int RECORD_TYPE_NUMPUSHUP = 2;
	public final static int RECORD_TYPE_NUMSITUP = 3;
	public final static int RECORD_TYPE_VALIDRATEPUSHUP = 4;
	public final static int RECORD_TYPE_VALIDRATESITUP = 5;
	public final static int RECORD_TYPE_DISTANCE = 6;
	public final static int RECORD_TYPE_PERFECTRATEPUSHUP = 7;
	public final static int RECORD_TYPE_PERFECTRATESITUP = 8;
	public final static int RECORD_TYPE_GRADEPUSHUP = 9;
	public final static int RECORD_TYPE_GRADESITUP = 10;
